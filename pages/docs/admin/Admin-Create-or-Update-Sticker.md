# Create or update a sticker set
...
| Name     | Description   |
| -------- | ------------- |
| tab.png  | The tab image |
| {##}.png | Sticker image |

{##} represents 01 ~ 99

```
POST /admin/stickers HTTP/1.1
...
1
--__X_PAW_BOUNDARY__
Content-Disposition: form-data; name="file"; filename="sticker.zip"
