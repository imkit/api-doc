...
### 已完成 - 韓文
✅ **2026-04-11 - 所有 59 個頁面的韓文翻譯已全部完成！**
...
- 聊天室相關頁面 (管理、成員、偏好)
- 訊息相關頁面 (基本功能、標記)
- 管理機制相關頁面 (封鎖、禁止、靜音、凍結、敏感詞)
- 監控與推送頁面
- Webhook 頁面

所有韓文 `.md` 文件已翻譯完成，並同步更新了導航配置 (`_meta.ts`)，提供完整的韓文 API 文檔支援。
